...
public class ActivityUserInfoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void sexDialog(String sex) {
        ...
        builder.setSingleChoiceItems(items, sexFlag, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Toast.makeText(ActivityUserInfoActivity.this,items[which],Toast.LENGTH_SHORT).show();;
                setSex(items[which]);
            }
        });
        builder.show();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.rl_signature:
                ...
                enterActivityForResult(ActivityChangeUserInfoActivity.class,CHANGE_NICKNAME,bdSignature);
                break;
        }
    }
}
