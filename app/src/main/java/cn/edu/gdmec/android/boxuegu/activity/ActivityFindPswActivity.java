            ...
            public void onClick(View view) {
                ...
                if ("security".equals(from)){
                    if (TextUtils.isEmpty(validateName)){
                        Toast.makeText(ActivityFindPswActivity.this,"请输入要验证的姓名",
                                Toast.LENGTH_SHORT).show();
                        return;
                    }else{
                        Toast.makeText(ActivityFindPswActivity.this,"密保设置成功",
                                Toast.LENGTH_SHORT).show();
                    ...
                    if (TextUtils.isEmpty(userName)){
                        Toast.makeText(ActivityFindPswActivity.this,"请输入您的用户名",
                                Toast.LENGTH_SHORT).show();
                        return;
                    }else if (!isExistUserName(userName)){
                        Toast.makeText(ActivityFindPswActivity.this,"您输入的用户名不存在",
                                Toast.LENGTH_SHORT).show();
                        return;
                        ...
                        Toast.makeText(ActivityFindPswActivity.this,"输入的密保不正确",
                                Toast.LENGTH_SHORT).show();
                        return;
                    }else{
